...
[![version](https://img.shields.io/badge/release-0.2.1-success)](https://deno.land/x/migrate@0.2.1)
...
import { PostgresMigrate } from "https://deno.land/x/migrate@0.2.1/postgres.ts";
// Import from GitHub
...
See [deno docs](https://doc.deno.land/https/deno.land/x/migrate@0.2.1/cli.ts)
...
See
[deno docs](https://doc.deno.land/https/deno.land/x/migrate@0.2.1/postgres.ts)
for more information.
